...
def _compose_standalone_module(
    ...
    parts = [
        ...
        *sorted(imports),
        ...
        "",
        "def _unpickle(s):",
        "    # Materialize a graph-specific object that a codegen'd wrapper closes over",
        "    # but that is neither an importable helper nor another wrapper -- e.g. a",
        "    # ViewMetaSequence (the view-replay recipe for an output that aliases an",
        "    # input). Such objects are pickle-embedded at compile and restored here.",
